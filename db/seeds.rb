...
card.photo.attach(io: file, filename: "manger_des_truc_bons.png", content_type: "image/png")
...
card.photo.attach(io: file, filename: "marcher_prendre_lair.png", content_type: "image/png")
...
card.photo.attach(io: file, filename: "regarder_des_series.png", content_type: "image/png")
...
card.photo.attach(io: file, filename: "faire_du_sport.png", content_type: "image/png")
...
activity_card_two = Card.create!(name: "Pilate", video = "https://www.youtube.com/watch?v=7ee-itHRGts&t=43s", outside: false, active: true)
...
card.photo.attach(io: file, filename: "siester.png", content_type: "image/png")
...
card.photo.attach(io: file, filename: "ecouter_sa_playlist_prefere.png", content_type: "image/png")
