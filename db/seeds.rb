...
activity_card_seven = Card.create!(name: "Playlist Méditation", playlist:"https://open.spotify.com/artist/5pDpKXDZXe97W5nPVRQo8A", outside: true, active: true)
...
activity_card_eight = Card.create!(name: "Playlist Méditation", playlist:"https://open.spotify.com/album/6GMlQBylzCYzGyuTCY0VJE", outside: true, active: false)
